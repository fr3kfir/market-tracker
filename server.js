...
const FIELDS = 'regularMarketPrice,regularMarketChangePercent,regularMarketOpen,regularMarketVolume,averageDailyVolume3Month,fiftyDayAverage,twoHundredDayAverage,fiftyTwoWeekHigh,fiftyTwoWeekLow,shortName,trailingPE,forwardPE,marketCap,priceToBook,epsTrailingTwelveMonths,beta,pegRatio,priceToSalesTrailingTwelveMonths,trailingAnnualDividendYield,epsForward,targetMeanPrice,sharesOutstanding,floatShares,earningsTimestampStart,earningsCallTimestampStart,marketState,regularMarketPreviousClose,preMarketPrice,preMarketChange,preMarketChangePercent,preMarketTime,postMarketPrice,postMarketChange,postMarketChangePercent,postMarketTime';
...
import etfHoldersHandler  from './api/etf-holders.js';
...
app.get('/api/etf-holders',  (req, res) => etfHoldersHandler(req, res));
